...
export ZSH="/Users/allanmogusu/.oh-my-zsh"
export LC_ALL=en_US.UTF-8

# Set name of the theme to load. Optionally, if you set this to "random"
# it'll load a random theme each time that oh-my-zsh is loaded.
# See https://github.com/robbyrussell/oh-my-zsh/wiki/Themes
source /Users/allanmogusu/awesome-terminal-fonts/build/*.sh
...
if [ -f '/Users/allanmogusu/Downloads/google-cloud-sdk/path.zsh.inc' ]; then . '/Users/allanmogusu/Downloads/google-cloud-sdk/path.zsh.inc'; fi

# The next line enables shell command completion for gcloud.
if [ -f '/Users/allanmogusu/Downloads/google-cloud-sdk/completion.zsh.inc' ]; then . '/Users/allanmogusu/Downloads/google-cloud-sdk/completion.zsh.inc'; fi
